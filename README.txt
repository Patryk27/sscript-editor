...
Ready-to-use, stable builds (with included compiler, VM and everything else) can be downloaded from:
https://github.com/Piterolex/SScript-Editor/tree/stable/build/